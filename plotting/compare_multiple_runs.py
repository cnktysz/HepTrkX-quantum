...
log_loc1 = 'logs/TTN/TTN_hid1_it2/'
log_loc2 = 'logs/TTN/TTN_hid1_it3/'

label0 = r'$N_{it}=1$'
label1 = r'$N_{it}=2$'
label2 = r'$N_{it}=3$'

pdf_location = 'pdf/TTN/layers/'
png_location = 'png/TTN/layers/'
"""
log_loc0 = 'logs/TTN/TTN_hid1_it1/'
log_loc1 = 'logs/TTN/TTN_hid2_it1/'

label0 = r'$N_{hid}=1$'
label1 = r'$N_{hid}=2$'

pdf_location = 'pdf/TTN/hid/'
png_location = 'png/TTN/hid/'
